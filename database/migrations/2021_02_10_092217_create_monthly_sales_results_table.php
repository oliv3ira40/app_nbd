...
class CreateMonthlySalesResultsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('monthly_sales_results', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('monthly_sales_results');
    }
}
