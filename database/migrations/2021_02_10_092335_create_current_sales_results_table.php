...
class CreateCurrentSalesResultsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('current_sales_results', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('current_sales_results');
    }
}
