(function() {
    ...
    var db = {
        ...
        loadData: function(filter) {
            return $.grep(this.professionals, function(client) {
        ...
        insertItem: function(insertingClient) {
            this.professionals.push(insertingClient);
        },

        updateItem: function(updatingClient) { },

        deleteItem: function(deletingClient) {
            var clientIndex = $.inArray(deletingClient, this.professionals);
            this.professionals.splice(clientIndex, 1);
        }
