...
@section('title', 'Editando funcionário: '. $data['entity']->name)
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Editando funcionário: {{ $data['entity']->name }}</h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap row">
                            {!! Form::model($data['user'], ['url'=>route('adm.employee.update')]) !!}
                                ...
                                <div class="form-group col-md-12 mb-0">
                                    <div class="col-md-12">
                                        {!! Form::submit('ATUALIZAR', ['class'=>'btn btn-sm btn-block btn-primary']) !!}
                                    </div>
                                </div>
                            {!! Form::close() !!}
                        </div>
