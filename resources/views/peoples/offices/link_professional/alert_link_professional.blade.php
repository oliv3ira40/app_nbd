...
@section('title', 'Desvinculando profissional do escritório')
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark nonecase-font">
                            Desvinculando profissional do escritório
                        </h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap row">
                            {!! Form::model($data['user'], ['url'=>route('adm.office.delete_link_professional')]) !!}
                                ...
                                <div class="form-group col-md-12 mb-0">
                                    <div class="col-md-12">
                                        {!! Form::submit('DESVINCULAR USUÁRIO', ['class'=>'btn btn-sm btn-block btn-danger']) !!}
                                    </div>
                                </div>
                            {!! Form::close() !!}
                        </div>
