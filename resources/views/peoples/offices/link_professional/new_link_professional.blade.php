...
@section('title', 'Vinculando profissional ao escritório')
                ...
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark nonecase-font">
                            Vinculando profissional ao escritório
                        </h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap row">
                            {!! Form::model($data['user'], ['url'=>route('adm.office.save_link_professional')]) !!}
                                ...
                                <div class="form-group col-md-12 mb-0">
                                    <div class="col-md-12">
                                        {!! Form::submit('CONFIRMAR VINCULO', ['class'=>'btn btn-sm btn-block btn-primary']) !!}
                                    </div>
                                </div>
                            {!! Form::close() !!}
                        </div>
