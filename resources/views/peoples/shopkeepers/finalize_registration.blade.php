                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap row">
                            {!! Form::open(['url'=>route('adm.shopkeeper.save_finalize_registration')]) !!}
                                ...
                                <div class="form-group col-md-12">
                                    <div class="col-md-4">
                                        ...
                                        {!! Form::text('user[telephone]', $data['user']->telephone, ['class'=>'form-control mask_telefone', 'id'=>'user[telephone]']) !!}
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group col-md-12">
                                    <div class="col-md-4">
                                        ...
                                        {!! Form::text('shopkeeper[telephone]', null, ['class'=>'form-control mask_telefone', 'id'=>'shopkeeper[telephone]']) !!}
                                    </div>
                                    <div class="col-md-4">
