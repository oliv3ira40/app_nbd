...
<head>
	...
	<!-- Data table CSS -->
	<link href="{{ asset('admin_theme/vendors/bower_components/datatables/media/css/jquery.dataTables.min.css') }}" rel="stylesheet" type="text/css"/>
	...
	<link href="{{ asset('admin_theme/vendors/bower_components/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}" rel="stylesheet" type="text/css"/>
	...
	<link href="{{ asset('admin_theme/vendors/bower_components/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css') }}" rel="stylesheet" type="text/css"/>
	...
	<!-- Fancy-Buttons CSS -->
	<link href="{{ asset('admin_theme/theme/dist/css/fancy-buttons.css') }}" rel="stylesheet" type="text/css">
